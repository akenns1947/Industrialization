...
#
mod <- feols(optimism_percentile ~ Science + Political.Economy + Science*Political.Economy + Science*Religion + Religion*Political.Economy + i(bin_20, Science, 1610) + i(bin_20, Religion, 1610) + i(bin_20, Political.Economy, 1610) + i(bin_20, Science*Religion, 1610) + i(bin_20, Science*Political.Economy, 1610) + i(bin_20, Political.Economy*Religion, 1610), data = volumes)

# mod <- feols(optimism_percentile ~ Science + Political.Economy + Science*Political.Economy + Science*Religion + Religion*Political.Economy + i(bin_20, Science) + i(bin_20, Religion) + i(bin_20, Political.Economy) + i(bin_20, Science*Religion) + i(bin_20, Science*Political.Economy) + i(bin_20, Political.Economy*Religion), data = volumes)
