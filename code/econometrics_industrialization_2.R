...
volumes <- volumes %>%
  rename(c("industry_percentile" = "industry_2_percentile"))
...
modelsummary(models[1:8],
             ...
             output = "../output/industry_2/mod_industry_1.tex")
...
modelsummary(models[9:15],
             ...
             output = "../output/industry_2/mod_industry_2.tex")
...
modelsummary(models,
             ...
             threeparttable = TRUE,
             notes = "Volumes are placed into 20 year ((+/-) 10 year) bins. Columns represent interactions between bin fixed effects and the variables of interest (rows). Observations prior to 1600 are dropped. Independent variables are indicators that take on a value of one for the highest weighted category for each volume. Standard errors in parenthesis.",
             output = "../output/industry_2/mod_industry_combined.tex")
...
write.csv(marginal_0, "../temporary/industry_2/marginal_0.csv")
write.csv(marginal_1, "../temporary/industry_2/marginal_1.csv")

marginal_0 <- read.csv("../temporary/industry_2/marginal_0.csv")
marginal_1 <- read.csv("../temporary/industry_2/marginal_1.csv")
